...
#Incremental RUN
if spark.catalog.tableExists('cars_catalog.gold.dim_date'):
    delta_tbl = DeltaTable.forPath(spark, 'abfss://gold@carvilsondatalake.dfs.core.windows.net/dim_date')
...
#Initial RUN
    ...
    df_final.write.format("delta")\
        .mode('overwrite')\
            .option('path', 'abfss://gold@carvilsondatalake.dfs.core.windows.net/dim_date')\
